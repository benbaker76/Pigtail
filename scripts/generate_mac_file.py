...
VENDOR_PATTERNS: List[Tuple[str, List[Pattern[str]]]] = [
    ...
    ("EssilorLuxottica",[rx(r"\bESSILORLUXOTTICA\b")]),
    ("Eufy",    [rx(r"\bEUFY\b")]),
    ("Flock",    [rx(r"\bFLOCK\b")]),
